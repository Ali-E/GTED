...
def main():
    # Secret Santa?
    g = Graph()
    g.add_vertex(Vertex("Roger0"))
    g.add_vertex(Vertex("Nitin0"))
    g.add_vertex(Vertex("Vincent0"))
    g.add_vertex(Vertex("Allan0"))
    g.add_vertex(Vertex("Roger1"))
    g.add_vertex(Vertex("Nitin1"))
    g.add_vertex(Vertex("Vincent1"))
    g.add_vertex(Vertex("Allan1"))
    g.add_edge(g.find_vertex("Roger0"), g.find_vertex("Nitin1"))
    g.add_edge(g.find_vertex("Roger0"), g.find_vertex("Nitin1"))
    g.add_edge(g.find_vertex("Roger0"), g.find_vertex("Vincent1"))
    g.add_edge(g.find_vertex("Roger0"), g.find_vertex("Allan1"))
    g.add_edge(g.find_vertex("Nitin0"), g.find_vertex("Roger1"))
    g.add_edge(g.find_vertex("Nitin0"), g.find_vertex("Vincent1"))
    g.add_edge(g.find_vertex("Nitin0"), g.find_vertex("Allan1"))
    g.add_edge(g.find_vertex("Vincent0"), g.find_vertex("Roger1"))
    g.add_edge(g.find_vertex("Vincent0"), g.find_vertex("Nitin1"))
    g.add_edge(g.find_vertex("Vincent0"), g.find_vertex("Allan1"))
    m = Matching.from_graph(g)
    m = find_maximum_matching(g, m)
    print(m)
